import type { User, Friends, ChatsUsers, Chats, Messages, MessageStatus, Blocked } from './schema';
import { users, friends, chats, chatsUsers, games, messages, messageStatus, blocked } from './schema';

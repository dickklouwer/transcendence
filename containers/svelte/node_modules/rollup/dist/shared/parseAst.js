...
const native_js = require('rollup/dist/native.js');
const path = require('node:path');

/** @typedef {import('rollup/dist/shared/types.js').Location} Location */

/**
 * @param {import('rollup/dist/shared/types.js').Range} range
 * @param {number} index
 */
...
/**
 * @param {string} source
 * @param {import('rollup/dist/shared/types.js').Options} [options]
 */
function getLocator(source, options = {}) {
	...
	const ranges = source.split('\n').map((line, i) => {
		...
		/** @type {import('rollup/dist/shared/types.js').Range} */

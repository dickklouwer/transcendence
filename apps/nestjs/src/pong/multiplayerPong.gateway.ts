  ...
  implements OnGatewayInit, OnGatewayConnection, OnGatewayDisconnect
{
  ...
  private handleRoomDisconnect(
    ...
    this.userGateway.setUserState({
      intra_user_id: room.players[0].client.data.intra_id,
      state: 'Online',
    });
    this.userGateway.setUserState({
      intra_user_id: room.players[1].client.data.intra_id,
      state: 'Online',
    });
  ...
  handleRegistration(
    ...
    this.userGateway.setUserState({
      intra_user_id: payload.intra_id,
      state: 'In-Game',
    });

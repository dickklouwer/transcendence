...
export default function Profile() {
  ...
  return (
    <div>
    <div className="flex flex-col justify-center items-center bg-slate-900 shadow-lg shadow-blue-500 rounded-lg ml-12 p-6 w-[83rem]">
    ...
    <div className="flex flex-grow justify-center space-x-12 p-12 w-full">
      <div className="bg-slate-900 shadow-lg shadow-blue-500 rounded-lg p-8 max-w-2xl ">
    ...
    <div className=" bg-slate-900 shadow-lg shadow-blue-500 rounded-lg p-8">

  ...
  return (
    <div className="flex flex-col items-center justify-center flex-grow space-y-4 ">
      ...
      <div className="flex items-center space-x-4 bg- p-4 rounded shadow">
        ...
        {/* TODO: [] Button GroupChatInvite Different location */}

        {/* Button with SVG */}
        <div className='flex justify-end'>
          <Link href={'/group_invite'}>
            <button className="flex items-end space-x-2 px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600 transition">
              <svg className="w-10 h-10 justify-center items-center" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 40 40">
